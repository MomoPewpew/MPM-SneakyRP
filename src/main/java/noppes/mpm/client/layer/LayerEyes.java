...
public class LayerEyes extends LayerInterface {
     ...
     private void drawLeft() {
          if (this.playerdata.eyes.pattern != 2) {
               ...
               this.drawRect(2.0D, -5.0D, 1.0D, -4.0D, this.playerdata.eyes.color, 4.011D, this.playerdata.eyes.type == 1);
               ...
               if (this.playerdata.eyes.type == 1) {
                    ...
                    this.drawRect(2.0D, -4.0D, 1.0D, -3.0D, this.playerdata.eyes.color, 4.011D, false);
               }
     ...
     private void drawBrows() {
          ...
          if (this.playerdata.eyes.blinkStart > 0L && this.player.isEntityAlive()) {
               ...
               this.drawRect(-3.0D, -5.0D, -1.0D, (double)(-5.0F + offsetY), this.playerdata.eyes.skinColor, 4.013D, false);
               this.drawRect(3.0D, -5.0D, 1.0D, (double)(-5.0F + offsetY), this.playerdata.eyes.skinColor, 4.013D, false);
          }
