...
public class AniHug {
  public static void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entity, ModelBiped base) {
    ...
    base.field_178723_h.rotateAngleZ += MathHelper.func_76134_b(ageInTicks * 0.09F) * 0.05F + 0.05F;
    base.field_178724_i.rotateAngleZ -= MathHelper.func_76134_b(ageInTicks * 0.09F) * 0.05F + 0.05F;
    base.field_178723_h.rotateAngleX += MathHelper.func_76126_a(ageInTicks * 0.067F) * 0.05F;
    base.field_178724_i.rotateAngleX -= MathHelper.func_76126_a(ageInTicks * 0.067F) * 0.05F;
  }
}
