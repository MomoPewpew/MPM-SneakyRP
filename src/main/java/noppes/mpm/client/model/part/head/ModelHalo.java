...
public class ModelHalo extends ModelBase {
	...
	public ModelHalo() {
		...
		this.setRotateAngle(this.halo_1, 0.0F, -0.5235988F, 0.0F);
		...
		this.setRotateAngle(this.halo_3, 0.0F, -0.5235988F, 0.0F);
		...
		this.setRotateAngle(this.halo_11, 0.0F, -0.5235988F, 0.0F);
		...
		this.setRotateAngle(this.halo, 0.0F, -0.2617994F, 0.0F);
		...
		this.setRotateAngle(this.halo_10, 0.0F, -0.5235988F, 0.0F);
		...
		this.setRotateAngle(this.halo_5, 0.0F, -0.5235988F, 0.0F);
		...
		this.setRotateAngle(this.halo_7, 0.0F, -0.5235988F, 0.0F);
		...
		this.setRotateAngle(this.halo_4, 0.0F, -0.5235988F, 0.0F);
		...
		this.setRotateAngle(this.halo_6, 0.0F, -0.5235988F, 0.0F);
		...
		this.setRotateAngle(this.halo_8, 0.0F, -0.5235988F, 0.0F);
		...
		this.setRotateAngle(this.halo_9, 0.0F, -0.5235988F, 0.0F);
		...
		this.setRotateAngle(this.halo_2, 0.0F, -0.5235988F, 0.0F);
