...
public class ModelHorseLegs extends ModelRenderer {
  ...
  public ModelHorseLegs(ModelBiped model) {
    ...
    body.func_78793_a(0.0F, 11.0F + yOffset, 9.0F + zOffset);
    func_78792_a(body);
    ...
    this.backLeftLeg.func_78793_a(4.0F, 9.0F + yOffset, 11.0F + zOffset);
    ...
    this.backRightLeg.func_78793_a(-4.0F, 9.0F + yOffset, 11.0F + zOffset);
    ...
    this.frontLeftLeg.func_78793_a(4.0F, 9.0F + yOffset, -8.0F + zOffset);
    ...
    this.frontRightLeg.func_78793_a(-4.0F, 9.0F + yOffset, -8.0F + zOffset);
